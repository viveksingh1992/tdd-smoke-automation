...
public class Inventory_TitleSearchActions extends TestBase {

	
	static boolean status = false;

	public static boolean TitleSearchNavigation() throws Exception {

		WebDriverUtils.moveToElement(AdminMasterMenuNavigationPageObjects.InventoryHoverLink());
		WebDriverUtils.ClickAction(AdminMasterMenuNavigationPageObjects.Inventory_TitleSearchLink(), "TitleSearch");
		if (WebDriverUtils
				.TextChecker(MasterMenuNavigationVerificationPageObjects.Inventory_TitleSearchVerificationText())
				.contentEquals(Environment.ReadExcelData("Inventory_Validator", 7, 0))) {
